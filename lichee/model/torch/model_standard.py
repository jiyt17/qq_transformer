...
from lichee.model.torch.VLT import CME
...
class ModelStandard(model_base.BaseModel):
    ...
    def forward(self, inputs):
        ...
        # encode title
        l_model = self.representation_model_arr[1]
        ...
        return self.task(video, title, label_inputs if len(label_inputs) > 0 else None)
